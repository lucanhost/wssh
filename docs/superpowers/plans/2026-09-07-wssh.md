...
func Accept(w http.ResponseWriter, r *http.Request) (net.Conn, error) {
	c, err := websocket.Accept(w, r, &websocket.AcceptOptions{
		...
		KeepAlivePingOptions: websocket.KeepAlivePingOptions{Interval: keepaliveInterval, Timeout: keepaliveTimeout},
	})
	if err != nil {
		return nil, err
	}
	return websocket.NetConn(c, websocket.MessageBinary), nil
}
